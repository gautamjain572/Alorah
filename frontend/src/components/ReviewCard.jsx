...
const data = [
    {
        ...
        date: '04 July 2023',
        img: `${assets.ri}`,
        review: `I recently purchased a lab-made diamond engagement ring, and I couldn't be happier. The clarity and brilliance are stunning, and it's nearly impossible to distinguish it from a natural diamond.`
    },
    {
        name: 'Sakshi Dubey',
        date: '7 August 2023',
