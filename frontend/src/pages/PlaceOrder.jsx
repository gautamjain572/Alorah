...
const PlaceOrder = () => {
  ...
  // backend payment method end

  return (
    <form onSubmit={onSubmitHnadler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      {/* left side  */}
